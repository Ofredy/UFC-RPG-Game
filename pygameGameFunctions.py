...
class PygameGameFunctions:
    ...
    def printaction(character1, character2, screen, background, damage, healed, num):
        ...
        screen.blit(pygame.image.load('warrior.png'),(character1.px,character1.py))
        ...
        if isinstance(character1, Wizard):
            pie1 = font2.render(character1.name + " has " + str(character1.health) + " health and " + str(character1.health) + " health", True, (255,255,0))
        else:
            pie2 = font2.render(character1.name + " has " + str(character1.health) + " health", True, (255,255,0))
        if isinstance(character2, Wizard):
            pie2 = font2.render(character2.name + " has " + str(character2.health) + " health and " + str(character2.health) + " health", True, (255,255,0))
        else:
